...
class CyphreTheme : public Theme
{
public:
    CyphreTheme() : Theme() { /* qDebug() << " ** running ownCloud theme!"; */ }
    ...
    virtual QString gitSHA1() const
    {
        ...
        const QString githubPrefix(QLatin1String(
                                       "https://github.com/servergy/cyphre-client/commit/"));
    ...
    {
        return QString::fromLatin1("http://docs.cyphre.com/client/%1.%2/").arg(MIRALL_VERSION_MAJOR).arg(MIRALL_VERSION_MINOR);
    }
private:
};
